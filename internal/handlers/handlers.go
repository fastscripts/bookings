...
func (m *Repository) Reservation(w http.ResponseWriter, r *http.Request) {
	var emptyReservaton models.Reservation
	data := make(map[string]interface{})
	data["reservation"] = emptyReservaton
...
// PostReservation handles the posting if reservation form
...
// AvailabilityJSON handles request for availability ans sends json response
